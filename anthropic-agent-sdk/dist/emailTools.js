...
export const listInboxTool = tool("list_inbox", "List recent emails in the inbox", {
...
export const readEmailTool = tool("read_email", "Read a specific email by ID", {
    id: z.string(),
}, async ({ id }, _extra) => {
...
export const sendEmailTool = tool("send_email", "Send an email (simulated: logs to console and stores in memory)", {
    to: z.string().email(),
    subject: z.string(),
    body: z.string(),
